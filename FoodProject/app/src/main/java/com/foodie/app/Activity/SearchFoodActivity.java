...
// activity_searchfood interface
        initToolbar();

        LayoutInflater inflater=new LayoutInflater(SearchFoodActivity.this) {
            @Override
        ...
        HttpRequest.handler=new Handler(){
            ...
            public void handleMessage(Message msg){
                if(msg.obj.equals(Code.fail)){
                    Toast.makeText(SearchFoodActivity.this,"request failed",Toast.LENGTH_SHORT).show();
                }else if(msg.obj.equals(Code.noRespond)){
                    Toast.makeText(SearchFoodActivity.this,"Request no response",Toast.LENGTH_SHORT).show();
                }else if(msg.obj.equals("nofood")){
                    Toast.makeText(SearchFoodActivity.this,"There is no menu to find this name",Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void updateDishes(String dis) {
        ...
        try{
            ...
            for (int i=0;i<jsonArray.length();i++){
                ...
                {
                    dishInfo.setPicture("https://assets.epicurious.com/photos/55f72d733c346243461d496e/master/pass/09112015_15minute_pastasauce_tomato.jpgm");
                }
                ...
                dishes.add(dishInfo);
                //after search food you will see the image of food whcih you search
            }
        }catch (Exception e){
            e.printStackTrace();
            // exceptioion
        }
        dishListAdapter = new DishListAdapter(SearchFoodActivity.this,dishes);
        dishListAdapter.setOnItemClickListener(new DishListAdapter.MyItemClickListener() {
            @Override
            public void onItemClick(View view, int postion) {
                Intent intent = new Intent(SearchFoodActivity.this, DishInfoActivity.class);
                ...
                // get the information from other class
    ...
    private void goPost(String quary){
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        NameValuePair pair1 = new BasicNameValuePair("foodname", quary);
        params.add(pair1);
        HttpRequest.goPost(params, Constant.GetListByName,true);
        //goPost method
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(SearchFoodActivity.this,MainActivity.class));
